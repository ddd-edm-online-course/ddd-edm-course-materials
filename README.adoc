...
. Each class offering has a unique GitHub Classroom invitation link. The link for the October 2018 offering is: https://classroom.github.com/a/uG8X9Kxd. Click on it.
...
Without GitHub and TravisCI accounts, you can still download the course materials manually, as a https://github.com/ddd-edm-online-course/2018-10-15-oreilly-online-trng/archive/master.zip[ZIP file]; you just will not receive personalized feedback on the exercises.
