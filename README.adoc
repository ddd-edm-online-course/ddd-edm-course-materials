...
. Each class offering has a unique GitHub Classroom invitation link. The link for the March 2019 Online Training offering is: https://classroom.github.com/a/2GORfrGw. Click on it.
...
Without GitHub and TravisCI accounts, you can still download the course materials manually, as a https://github.com/ddd-edm-online-course/2019-03-06-oreilly-online-trng/archive/master.zip[ZIP file]; you just will not receive personalized feedback on the exercises.
