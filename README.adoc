...
. Each class offering has a unique GitHub Classroom invitation link. The link for this offering is: *<URL NOT YET CREATED>*. Click on it.
...
Without GitHub and TravisCI accounts, you can still download the course materials manually, as a http://example.com[ZIP file (NOT YET AVAILABLE)]; you just will not receive personalized feedback on the exercises.
