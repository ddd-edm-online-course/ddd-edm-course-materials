...
. Each class offering has a unique GitHub Classroom invitation link. The link for the July 2022 offering is: https://classroom.github.com/a/-gGLeJxD[2022-07-26-oreilly-online-trng]. Click on it.
...
Without a GitHub account, you can still download the course materials manually, as a https://github.com/ddd-edm-online-course/2022-07-26-oreilly-online-trng/archive/refs/heads/master.zip[ZIP file]; you just will not receive personalized feedback on the exercises.
