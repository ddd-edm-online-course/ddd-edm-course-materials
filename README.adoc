...
This class will be offered via https://www.oreilly.com/attend/[O'Reilly's Live Online Training Platform] on a periodic basis. Watch the link for scheduled offerings!
