...
. Each class offering has a unique GitHub Classroom invitation link. The link for the February 2021 offering is: <TBD>. Click on it.
...
Without a GitHub account, you can still download the course materials manually, as a https://github.com/<TODO>[ZIP file]; you just will not receive personalized feedback on the exercises.
