...
. Each class offering has a unique GitHub Classroom invitation link. The link for the April 2019 Great International Developer Summit (GIDS) offering is: https://classroom.github.com/a/tpi4f7B2. Click on it.
...
Without GitHub and TravisCI accounts, you can still download the course materials manually, as a https://github.com/ddd-edm-online-course/2019-04-26-gids/archive/master.zip[ZIP file]; you just will not receive personalized feedback on the exercises.
