...
. Each class offering has a unique GitHub Classroom invitation link. The link for the SDD 2019 offering is: https://classroom.github.com/a/0gzJCeW_. Click on it.
...
Without GitHub and TravisCI accounts, you can still download the course materials manually, as a https://github.com/ddd-edm-online-course/2019-05-24-sdd/archive/master.zip[ZIP file]; you just will not receive personalized feedback on the exercises.
