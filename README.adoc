...
. Each class offering has a unique GitHub Classroom invitation link. The link for the November 2018 offering is: https://classroom.github.com/a/P11PrDww. Click on it.
...
Without GitHub and TravisCI accounts, you can still download the course materials manually, as a https://github.com/ddd-edm-online-course/2018-11-19-oreilly-online-trng/archive/master.zip[ZIP file]; you just will not receive personalized feedback on the exercises.
