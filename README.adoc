...
. Each class offering has a unique GitHub Classroom invitation link. The link for the ArchConf 2018 offering is: https://classroom.github.com/a/QlawwXKQ. Click on it.
...
Without GitHub and TravisCI accounts, you can still download the course materials manually, as a https://github.com/ddd-edm-online-course/2018-archconf/archive/master.zip[ZIP file]; you just will not receive personalized feedback on the exercises.
